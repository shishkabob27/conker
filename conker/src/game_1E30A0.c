...
/*void func_151B5E94(struct127 *arg0) {
    ...
    if (D_800AA438 < arg0->unk170) {
        arg0->unk170 = 0.0f;
        func_10010F88(0x502, 0x5DC0, 0, 0, -1, (s32) arg0->unk38, (s32) arg0->xz_velocity, (s32) arg0->unk40, 0x64, 0x1F4);
    }
    temp_v0 = arg0 + 0x170;
    ...
    if (var_f12 < D_800AA43C) {
        ...
        arg0->z_position = temp_f2;
        arg0->y_position = temp_f2;
    } else {
        temp_f2_2 = temp_v0->unk4;
        arg0->z_position = temp_f2_2;
        arg0->y_position = temp_f2_2;
    }
